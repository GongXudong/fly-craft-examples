...
# python evaluate/sb3_rollout_parallel_for_checking_precision_termination_smooth.py --eval-traj-num 10000 --process-num 10 --seed 123
...
if __name__ == "__main__":
    ...
    for config_file_name, algo_str, save_file_name in zip(
        ...
        with Pool(processes=args.process_num) as pool:
            ...
            res_df.to_csv(PROJECT_ROOT_DIR / "train_scripts"/ "D2D" / "evaluate" /"cache" / save_file_name, index=False)
