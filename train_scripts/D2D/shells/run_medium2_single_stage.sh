...
python train_scripts/D2D/train_with_rl_sac_her_multi_stages.py --config-file-name configs/train/D2D/relative_sac/two_stage_relative_hard_b_2_b_05/sac_config_10hz_128_128_1.json