...
def train(train_config):
    ...
    for index, train_this_iter_config in enumerate(train_config["rl_train"]):
        ...
        unified_indicator_callback = UnifiedNetworkMonitorCallback(check_freq=THIS_ITER_CHECK_FRQ,batch_size=THIST_ITER_INDICATOR_BATCH,dormant_tau=THIS_ITER_TAU,verbose=1)
