...
def train(train_config):
    ...
    for index, train_this_iter_config in enumerate(train_config["rl_train"]):
        ...
        # dormant callback
        dorm_callback = DormantNeuronMonitorCallback(check_freq=10000, tau=THIS_ITER_TAU, batch_size=256, verbose=1)
        ...
        sac_algo.learn(
            ...
            callback=[eval_callback, event_callback,dorm_callback]
        )
