...
def train(train_config):
    ...
    for index, train_this_iter_config in enumerate(train_config["rl_train"]):
        ...
        This_ITER_ENV_MAX_STEP = train_this_iter_config["env"]["max_episode_steps"]
        This_ITER_ENV_N_SUBSTEP = train_this_iter_config["env"]["n_substeps"]
        This_ITER_ENV_EVAL_MAX_STEP = train_this_iter_config["env"]["eval_max_episode_steps"]
        This_ITER_ENV_EVAL_N_SUBSTEP = train_this_iter_config["env"]["eval_n_substeps"]
        ...
        vec_env = make_vec_env(
            ...
            env_kwargs={
                "max_episode_steps":This_ITER_ENV_MAX_STEP,
                "n_substeps":This_ITER_ENV_N_SUBSTEP
            }
        )
        ...
        eval_env_in_callback = make_vec_env(
            ...
            env_kwargs={
                "max_episode_steps":This_ITER_ENV_EVAL_MAX_STEP,
                "n_substeps":This_ITER_ENV_EVAL_N_SUBSTEP
            }
        )
