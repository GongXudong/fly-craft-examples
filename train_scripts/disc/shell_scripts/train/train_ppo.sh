...
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_0_1/ppo_bc_config_10hz_128_128_seed_1.json
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_0_1/ppo_bc_config_10hz_128_128_seed_2.json
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_0_1/ppo_bc_config_10hz_128_128_seed_3.json
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_0_1/ppo_bc_config_10hz_128_128_seed_4.json
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_0_1/ppo_bc_config_10hz_128_128_seed_5.json

# epsilon = [1.0, 0.3, 0.3]  regularization_strength = 1.0
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_1/ppo_bc_config_10hz_128_128_seed_1.json
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_1/ppo_bc_config_10hz_128_128_seed_2.json
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_1/ppo_bc_config_10hz_128_128_seed_3.json
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_1/ppo_bc_config_10hz_128_128_seed_4.json
python train_scripts/disc/train_ppo.py --config-file-name configs/train/disc/ppo/medium/epsilon_0_1_reg_1/ppo_bc_config_10hz_128_128_seed_5.json
