...
from train_scripts.msr.algorithms.smooth_goal_sac_detach import SmoothGoalSAC
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config-file-name", type=str, help="配置文件名", default="configs/train/msr/sac/medium/sac_config_10hz_128_128_1.json")
