...
python train_scripts/msr/train/train_bc.py --config-file-name configs/train/msr/bc/hard/epsilon_0_1_reg_0_0001_N_16/128_128_seed_1.json
python train_scripts/msr/train/train_bc.py --config-file-name configs/train/msr/bc/hard/epsilon_0_1_reg_0_0001_N_16/128_128_seed_2.json
python train_scripts/msr/train/train_bc.py --config-file-name configs/train/msr/bc/hard/epsilon_0_1_reg_0_0001_N_16/128_128_seed_3.json
python train_scripts/msr/train/train_bc.py --config-file-name configs/train/msr/bc/hard/epsilon_0_1_reg_0_0001_N_16/128_128_seed_4.json
python train_scripts/msr/train/train_bc.py --config-file-name configs/train/msr/bc/hard/epsilon_0_1_reg_0_0001_N_16/128_128_seed_5.json
