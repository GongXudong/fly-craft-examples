...
python train_scripts/msr/evaluate/evaluate_ppo_with_average_adjacent_KL.py --env-config configs/env/VVCGym/env_hard_config_for_sac.json --env-flag-str Hard-05 --algo-class SmoothGoalPPO --algo-ckpt-dir checkpoints/msr/hard/bc/iter_4_aug/epsilon_0_1_reg_1_N_16/256_256_128_128_64_300epochs_seed_{0} --algo-ckpt-model-name bc_checkpoint --algo-seeds 1 2 3 4 5 --algo-flag-str SmoothGoalPPO --algo-epsilon 0.1 --algo-reg 1 --evaluate-dg-num 100 --evaluate-noise-base 10.0 3.0 3.0 --evaluate-noise-multiplier 1.0 --evaluate-adjacent-num 5 --res-file-save-name train_scripts/msr/plots/bc/results/bc_iter_4_epsilon_0_1_reg_1_N_16_noise_0_1.csv

# algo: epsilon 0.1 reg 1  noise_num: 16  eval: epsilon 1.0
python train_scripts/msr/evaluate/evaluate_ppo_with_average_adjacent_KL.py --env-config configs/env/VVCGym/env_hard_config_for_sac.json --env-flag-str Hard-05 --algo-class SmoothGoalPPO --algo-ckpt-dir checkpoints/msr/hard/bc/iter_4_aug/epsilon_0_1_reg_1_N_16/256_256_128_128_64_300epochs_seed_{0} --algo-ckpt-model-name bc_checkpoint --algo-seeds 1 2 3 4 5 --algo-flag-str SmoothGoalPPO --algo-epsilon 0.1 --algo-reg 1 --evaluate-dg-num 100 --evaluate-noise-base 10.0 3.0 3.0 --evaluate-noise-multiplier 1.0 --evaluate-adjacent-num 5 --res-file-save-name train_scripts/msr/plots/bc/results/bc_iter_4_epsilon_0_1_reg_1_N_16_noise_1.csv



# algo: epsilon 0.1 reg 10  noise_num: 16  eval: epsilon 0.1
python train_scripts/msr/evaluate/evaluate_ppo_with_average_adjacent_KL.py --env-config configs/env/VVCGym/env_hard_config_for_sac.json --env-flag-str Hard-05 --algo-class SmoothGoalPPO --algo-ckpt-dir checkpoints/msr/hard/bc/iter_4_aug/epsilon_0_1_reg_10_N_16/256_256_128_128_64_300epochs_seed_{0} --algo-ckpt-model-name bc_checkpoint --algo-seeds 1 2 3 4 5 --algo-flag-str SmoothGoalPPO --algo-epsilon 0.1 --algo-reg 10 --evaluate-dg-num 100 --evaluate-noise-base 10.0 3.0 3.0 --evaluate-noise-multiplier 1.0 --evaluate-adjacent-num 5 --res-file-save-name train_scripts/msr/plots/bc/results/bc_iter_4_epsilon_0_1_reg_10_N_16_noise_0_1.csv

# algo: epsilon 0.1 reg 10  noise_num: 16  eval: epsilon 1.0
python train_scripts/msr/evaluate/evaluate_ppo_with_average_adjacent_KL.py --env-config configs/env/VVCGym/env_hard_config_for_sac.json --env-flag-str Hard-05 --algo-class SmoothGoalPPO --algo-ckpt-dir checkpoints/msr/hard/bc/iter_4_aug/epsilon_0_1_reg_10_N_16/256_256_128_128_64_300epochs_seed_{0} --algo-ckpt-model-name bc_checkpoint --algo-seeds 1 2 3 4 5 --algo-flag-str SmoothGoalPPO --algo-epsilon 0.1 --algo-reg 10 --evaluate-dg-num 100 --evaluate-noise-base 10.0 3.0 3.0 --evaluate-noise-multiplier 1.0 --evaluate-adjacent-num 5 --res-file-save-name train_scripts/msr/plots/bc/results/bc_iter_4_epsilon_0_1_reg_10_N_16_noise_1.csv
